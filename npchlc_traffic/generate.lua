function initTrafficGenerator()
	traffic_density = {peds = 0.01,cars = 0.0005,boats = 0.01,planes = 0.01}
...
function updateTraffic()
	...
	npc_realism = getResourceFromName("npc_realism")
	if npc_realism and getResourceState(npc_realism) ~= "running" then npc_realism = nil end
...
function spawnTrafficInSquare(x,y,dim,trtype)
	...
	while count_needed >= 1 do
		...
		if create and trtype == "peds" then
			...
			if npc_realism then call(npc_realism,"initTrafficPed",ped) end
